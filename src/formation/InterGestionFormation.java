...
public interface InterGestionFormation {
   ...
   * formation existait deja dans le systeme, la nouvelle la remplace et efface
   * la precedente.
   *
   ...
   *
   * @param nombre le nombre d'options a choisir pour un etudiant (nombre
  ...
  /**
   * Attribue automatiquement les etudiants non encore affectes a des groupes de
   ...
   * d'affectation reçoivent un message pour leur preciser ce qu'il s'est passe.
   */
