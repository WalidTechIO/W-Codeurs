...
/**
 * Description des informations personnelles d'un etudiant :
 * identite, age et adresse.
 *
 * @author Eric Cariou
 */
public final class InformationPersonnelle implements java.io.Serializable {
   ...
   */
  public InformationPersonnelle(String nom, String prenom) throws InformationPersonnelleException {
    this(nom, prenom, "", 0);
  }
  ...
  public InformationPersonnelle(String nom, String prenom, String adresse,
      int age) throws InformationPersonnelleException {
    super();
    if (nom == null || nom.isBlank() || prenom == null || prenom.isBlank()) {
      throw new InformationPersonnelleException();
    }
    this.nom = nom;
    this.prenom = prenom;
